...
class Session {
  constructor(category, title, description, salespoint, level, day, startAt, duration) {
...
export function LoadSpeakers() {
    return [
      ...
      new Speaker("민성현", "Samsung Research", "Staff Engineer",
                  ...
                  [new Session(sessionCategory[2],
                              ".NET MAUI 소개",
                              ".NET MAUI는 iOS, Android, Windows, MacOS, Tizen등 다양한 플랫폼을 지원하는 앱을 개발하기 위해 가장 효과적인 기술입니다. 이번 발표에서는 .NET MAUI의 새로운 기능과 더불어 Visual Studio 2022를 활용하여 .NET MAUI 앱을 만들고 다양한 플랫폼에서 실행하는 방법을 소개합니다.",
      ...
      new Speaker("정세일", "마음인", "CTO",
                  ...
                  [new Session(sessionCategory[2],
                              ...
                              1, 2,
                              new TimeSpan(0,0,5,13), 48)]
                ),
      
      new Speaker("김상현", "OnePredict", "Software engineer",
                  "김상현님은 Software engineer로써 현명한 애플리케이션 서비스를 위한 아키텍처링과 응집력 높은 기술 조직 운영 방법에 관심이 많습니다.<br>애플리케이션 서비스를 위해 요구되는 다양한 기술 이해도를 바탕으로 매년 개최되는 .NET Conf에 꾸준히 참가하고 있습니다. 또한 국내 소프트웨어 기술 커뮤니티에서 활발히 활동하고 있습니다.",
